# %% [markdown]
# # Traffic Light Controller for a Single 4-Way Road Intersection using Deep Q Network algorithm
...
for episode in range(num_eval_episodes):
    ...
    while not done:
        ...
        action, _ = dqn_model.predict(state, deterministic=True)  # Use deterministic for inference
